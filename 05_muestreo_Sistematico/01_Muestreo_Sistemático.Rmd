...
Pude ser combinado con otros procedimientos de muestreo, y puede ser utilizado en la practica por su relativa facilidad de administración en el trabajo de campo. 
...
$\{q, q_0 + q, q_0 + 2q, q_0 + 3q, \dots , q_0 + (n-1)q \}$
...
En este caso es más probable que el muestreo sistemático sea más preciso que el muestreo aleatorio. Esto se debe a que la muestra queda más dispersa en la población. Intuitivamente, en este caso el muestreo sistematico cunrira elementos en todos los rangos de la población. 
...
```{r}
indice_elementos3 <- indice_elementos  + 98
